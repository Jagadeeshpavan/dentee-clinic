...
const Rxtemplate = () => {
  return (
    ...
    <div className='Rxds'>
        ...
        <div className='mainhead-icon-rx'><Link to='/Administator'><AiOutlineArrowLeft/></Link></div>
        <div className='main-heading-rx'>Report / Patient Documents</div>
       </div>
            {/* <div className='rx-text'>Administrator / Manage RX Template </div> */}
